...
public abstract class BaseCtl extends HttpServlet {
	...
	/**
	 * Validates the request parameters. Override this in subclass controllers if
	...
	/**
	 * Preloads data before the page load. Override in subclass controllers if
	...
	/**
	 * Populates a bean from the request parameters. Override in subclass
	 * controllers for specific bean population.
	 */
	...
	/**
	 * Populates basic DTO fields like createdBy, modifiedBy, createdDatetime, and
	 * modifiedDatetime.
	 *
	...
	/**
	 * The main service method for handling all requests. This method handles
	 * preload, validation, and populates data.
	 */
	@Override
	...
	/**
	 * Returns the view page for the specific controller. Each subclass must
