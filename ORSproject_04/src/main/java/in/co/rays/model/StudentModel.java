...
public class StudentModel {
	...
	public void add(StudentBean bean) throws Exception {
		...
		if (existbean != null) {
			...
			throw new Exception("user not allowed to add data");
	...
	public void update(StudentBean bean) throws Exception {
		...
		StudentBean exsitbean = findByEmail(bean.getEmail());

		if (exsitbean != null && bean.getId() != exsitbean.getId()) {
			throw new Exception("user not aloowed to update data");
	...
	public void delete(long id) throws Exception {
		...
		System.out.println("data dalete successfully = " + i);
